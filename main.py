...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://happy-coast-068f78503.2.azurestaticapps.net", "https://manager.terminaleai.pl"],  # produkcyjnie: ["https://victorious-bush-0d4d65503.1.azurestaticapps.net"]
